...
function Client(options) {
  ...
  if (this.multipartUploadSize > constants.MAX_PUTOBJECT_SIZE) {
...
Client.prototype.deleteObjects = function (s3Params) {
  ...
  var slices = utils.chunkArray(
    params.Delete.Objects,
    constants.MAX_DELETE_COUNT
  );
...
function smallestPartSizeFromFileSize(fileSize) {
  ...
  return partSize < constants.MIN_MULTIPART_SIZE
    ? constants.MIN_MULTIPART_SIZE
    : partSize;
}
